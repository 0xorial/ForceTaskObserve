...
namespace ForceTaskObserve.Deployment
{
    internal static class Program
    {
        ...
        static void CopyAssembly([NotNull] string executionDirectoryPath, [NotNull] out string assemblyPath, out bool isReleaseBuild)
        {
            ...
            const string fileName = "ForceTaskObserve.dll";
            ...
            var sourceAssemblyPath = Path.Combine(executionDirectoryPath, @"..\..\..\..\ForceTaskObserve\bin\x86", executionDirectory, fileName);
